      ...
      <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-5 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <span class="customerfeed"></span><span id="customerfeed"></span>

<form onsubmit="return false"  class="newcustomer" action="process/newcustomer.php" method="POST">
...
<?php require 'modals/editcustomer.php'; ?>
