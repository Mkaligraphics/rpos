...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2022 at 06:11 PM
...
INSERT INTO `products_table` (`id`, `product_name`, `description`, `category_id`, `no_units`, `reorder`, `online_price`, `photo1`, `company_id`, `s`, `user_id`) VALUES
(1, 'Toast Bread(2)', '-', 1, 28, 0, '50.00', 'toast_bread.jpg', 1, 1, 1),
(2, 'Fried Eggs', '-', 1, 0, 0, '70.00', 'fried_egss.jpg', 1, 1, 1),
(3, 'Spanish Ommelete (2 eggs)', '-', 1, 0, 0, '150.00', 'Spanish_Ommelete.jpg', 1, 1, 1),
(4, '(Chopped onions, tomatoes and green pepper)', '-', 1, 1, 0, '0.00', 'Chopped_onions_tomatoes_green_pepper.jpg', 1, 0, 1),
(5, 'Scrambled Eggs (2)', '-', 1, 0, 0, '100.00', 'Scrambled_Eggs.jpg', 1, 1, 1),
(6, 'Waqanda Pancakes(3)', '-', 1, 0, 0, '200.00', 'no-image.jpg', 1, 1, 1),
...
(16, 'Coleslaw (Cabbage And Mayonnaise)', 'Cabbage and Mayonnaise', 3, 0, 0, '250.00', 'no-image.jpg', 1, 1, 1),
...
(32, 'Vegetable soup(Mixed vegetable)', '-', 8, 0, 0, '200.00', 'no-image.jpg', 1, 1, 1),
...
INSERT INTO `sales_details` (`id`, `details`, `qty`, `unit_price`, `unit_total`, `product_id`) VALUES
(1, 'RCPT2022111520', 1, '250.00', '250.00', 16),
(3, 'RCPT-20221115677', 1, '100.00', '0.00', 5),
(4, 'RCPT-20221115533', 1, '50.00', '0.00', 1),
(5, 'RCPT-20221115924', 1, '70.00', '0.00', 2),
(6, 'RCPT-20221115859', 1, '200.00', '200.00', 6),
(7, 'RCPT-20221118947', 1, '200.00', '200.00', 32),
(8, 'RCPT-20221118947', 1, '50.00', '50.00', 1),
(9, 'RCPT-20221118947', 1, '50.00', '50.00', 1);
...
CREATE TABLE `sales_table` (
  ...
  `s` int(11) NOT NULL DEFAULT 1,
  `user_id` int(11) NOT NULL,
  `cashout` varchar(255) NOT NULL DEFAULT 'no',
  `timestamp` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `sales_table` (`id`, `details`, `total_items`, `sub_total`, `table_id`, `customer_id`, `s`, `user_id`, `cashout`, `timestamp`) VALUES
(38, 'RCPT2022111520', 1, '250.00', 2, 1, 1, 6, 'no', '2022-11-15 06:52:03'),
(40, 'RCPT-20221115677', 1, '100.00', 3, 1, 1, 3, 'no', '2022-11-15 10:18:20'),
(41, 'RCPT-20221115533', 1, '50.00', 3, 1, 1, 3, 'no', '2022-11-15 11:15:10'),
(42, 'RCPT-20221115924', 1, '70.00', 3, 1, 1, 3, 'no', '2022-11-15 11:18:27'),
(43, 'RCPT-20221115859', 1, '200.00', 3, 1, 1, 3, 'no', '2022-11-15 11:22:10'),
(44, 'RCPT-20221118947', 3, '400.00', 1, 1, 1, 6, 'no', '2022-11-18 07:45:58');
